...
def test_sigmoid(a: float) -> None:
    ...
    * It is  strictly increasing.
    ...
    assert pytest.approx(1 - sigmoid(a)) == sigmoid(-a) #тут мне гпт подсказала что для флотов лучше писать approx
...
def test_symmetric() -> None:
    ...
    """
    assert mul(2.1, 3.3) == pytest.approx(mul(3.3, 2.1))
...
def test_distribute() -> None:
    ...
    """
    assert mul(4.5, add(1, 3)) == pytest.approx(add(mul(4.5, 1), mul(4.5, 3)))
